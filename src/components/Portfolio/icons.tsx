...
export function LinkedIn({ size = 26 }: IconProps) {
  return (
    <svg
      aria-hidden="true"
      width={size}
      ...
      fill="currentColor"
    >
      <path d="M6.5 8.3H3.2V21h3.3V8.3ZM4.9 3A1.9 1.9 0 1 0 5 6.8 1.9 1.9 0 0 0 5 3ZM21 13.7c0-3.8-2-5.6-4.7-5.6a4.1 4.1 0 0 0-3.7 2v-1.8H9.3V21h3.3v-6.3c0-1.7.3-3.3 2.4-3.3 2 0 2.1 1.9 2.1 3.4V21H21v-7.3Z" />
    </svg>
  );
}
...
export function Mail({ size = 26 }: IconProps) {
  return (
    <svg
      aria-hidden="true"
      width={size}
